...
inline constexpr Scene SCENES[NUM_SCENES] = {
    ...
    { "Fade to Black",
      { FxPatchId::Passthrough, FxPatchId::Passthrough, FxPatchId::LIFModulate },
    ...
    { "Rainbow",
      { FxPatchId::RainbowShift, FxPatchId::RainbowShift, FxPatchId::LIFModulate },
      { {0.5f,0.5f}, {0.3f,0.7f}, {0.7f,0.3f} } },

    // 03  D#2  – beat-ready pixelate on slot 0, hue on others
    { "Pixelate",
      { FxPatchId::Pixelate, FxPatchId::HueCycle, FxPatchId::LIFModulate },
      { {0.3f,0.5f}, {0.2f,0.5f}, {0.5f,0.5f} } },

    // 04  E2   – julia fractal overlay + chromatic on top
    { "Julia",
      { FxPatchId::JuliaFractal, FxPatchId::ChromaticAberr, FxPatchId::LIFModulate },
      { {0.6f,0.4f}, {0.5f,0.5f}, {0.5f,0.5f} } },

    // 05  F2   – glitch storm: glitch + wave + chroma
    { "Glitch Storm",
      { FxPatchId::VideoGlitch, FxPatchId::WaveDistort, FxPatchId::LIFReplace },
    ...
    { "Circle Quilt",
      { FxPatchId::CircleQuilt, FxPatchId::Passthrough, FxPatchId::LIFModulate },
      { {0.5f,0.8f}, {0.5f,0.5f}, {0.5f,0.5f} } },

    // 08  G#2  – CA glow on all layers
    { "CA Glow",
      { FxPatchId::CAGlow, FxPatchId::CAGlow, FxPatchId::LIFModulate },
      { {0.4f,0.5f}, {0.6f,0.3f}, {0.5f,0.5f} } },

    // 09  A2   – Wolfram bitplane reactor
    { "Bitplane",
      { FxPatchId::BitplaneReactor, FxPatchId::Passthrough, FxPatchId::LIFModulate },
      { {0.72f,0.5f}, {0.5f,0.5f}, {0.3f,0.5f} } },

    // 10  A#2  – soft blur haze
    { "Blur Haze",
      { FxPatchId::Blur, FxPatchId::Blur, FxPatchId::LIFModulate },
      { {0.3f,0.5f}, {0.2f,0.5f}, {0.5f,0.5f} } },

    // 11  B2   – edge ink + rainbow
    { "Ink Rainbow",
      { FxPatchId::EdgeInk, FxPatchId::RainbowShift, FxPatchId::LIFModulate },
      { {0.4f,0.7f}, {0.5f,0.6f}, {0.5f,0.5f} } },

    // 12  C3   – julia + feedback + CA glow (deep audio-reactive)
    { "Deep Space",
      { FxPatchId::JuliaFractal, FxPatchId::FeedbackZoom, FxPatchId::LIFReplace },
      { {0.5f,0.3f}, {0.4f,0.2f}, {0.5f,0.6f} } },

    // 13  C#3  – kitchen sink: everything layered
    { "Total Chaos",
      { FxPatchId::VideoGlitch, FxPatchId::Kaleidoscope, FxPatchId::LIFReplace },
    ...
    { "Noise Warp Loop",
      { FxPatchId::Ripple, FxPatchId::FeedbackZoom, FxPatchId::LIFModulate },
